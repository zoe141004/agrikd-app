...
def load_config(path=None):
    ...
    1. ``path`` argument (used in tests)
    2. ``AGRIKD_CONFIG`` environment variable
    3. Default ``config/config.json`` relative to CWD
    """
    resolved = path or os.environ.get("AGRIKD_CONFIG", "config/config.json")
