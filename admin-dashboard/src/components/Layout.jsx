...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/reports', label: 'Model Reports', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2z"/></svg> },
    ]
  },
  {
    group: 'Management',
    items: [
      ...
      { to: '/devices', label: 'Devices', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8m-4-4v4"/></svg> },
